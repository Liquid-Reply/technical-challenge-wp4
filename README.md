...
- [VM, endpoint \& performance monitoring](#vm-endpoint--performance-monitoring)
  ...
  - [Monitoring](#monitoring)
    - [Data Sources](#data-sources)
      ...
      - [Prometheus (Azure Monitor workspace)](#prometheus-azure-monitor-workspace)
  - [Alerting](#alerting)
...
![Upload & Download Speeds](./img/docker_container_dashboard.png)
  
  **SSL Certificate Validity / HTTP Endpoint Monitoring**
  ![Blackbox Exporter Dashboard](./img/blackbox_exporter_dashboard.png)

## Alerting

Alerts can be created from Grafana based on Prometheus Metrics or already created dashboard charts. Following you will find an example configuration of an Alert for SSL Certificates that will expire in less than 1 week:
**Alert Query**
![Alert Query](./img/ssl_expiry_alert.png)

**Alert configuration (1 week)**
![Alert configuration](./img/ssl_expiry_alert_condition.png)
